...
# NOTE:
# THIS SCRIPT IS A VERSION OF upgrade-mw.sh THAT WAS USED TO UPGRADE FROM 1.32,
# IT MIGHT HELP TO GET SELF-HOSTED VERSIONS RUNNING IN THE FUTURE, SO UNTIL WE
# HAVE ESTABLISHED A WAY FOR PEOPLE TO GET THEIR OWN HITCHWIKI UP AND RUNNING,
# WE SHOULD KEEP THIS FILE AROUND FOR REFERENCE.
